...
class DESCipher{
	int[] IP = { 58, 50, 42, 34, 26, 18, 
        ...
        public String ptext,key;
        public StringBuffer ptextbin;
        public DESCipher(String p,String k){
        	this.ptext = p;
        	this.key = k;
        }

        // public StringBuffer hexToBin(String s ){
        ...
        // 		String sub = Integer.toBinaryString(a);
        // 		if(sub.length()<4){
        // 			for(int j=sub.length();j<4;j++){
        // 				ans.append("0");
        // 			}
        // 		} 
        // 		ans.append(sub);
...
public class DES{
  ...
  //       String key = "AABB09182736CCDD"; 
        ...
        DESCipher cipher = new DESCipher(ptext, key);
      //  System.out.println(cipher.binToHex(s).toUpperCase());

        System.out.println("Encryption:\n"); 
        String text = cipher.encrypt(ptext, key); 
        System.out.println( 
